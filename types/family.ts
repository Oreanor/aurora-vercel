...
/**
 * Kind of parent-child relationship (optional; omitted = biological).
 */
export type RelationshipType = 'biological' | 'adopted';
...
export interface Relationship {
  ...
  /** If set, adopted; otherwise biological. Used for styling (e.g. dashed edge). */
  type?: RelationshipType;
}

/**
 * Explicit spouse link (for couples without shared children)
 */
...
export interface FamilyTreeData {
  ...
  /** Explicit spouse pairs (e.g. childless couples). Pairs inferred from shared children are not stored here. */
